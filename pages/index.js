...
function Home() {
  return <Content>
			<SectionBlock padding="10px 10%" paddingsm="10px 0px 25px 0px">
				...
				<Image src="/assets/N5GkXT0uTk7yS0R6mpEJJX6zyo.png" maxwidth="70%"  />
			</SectionBlock>
			<SectionBlock padding="30px 0% 30px 0%" paddingsm="30px 0px 30px 0px" color={SectionBlockColors.Charcoal}>
				...
				<TextStyleBlock align={TextStyleBlockAlign.Middle} size="22px" color="#55ccff" margin="25px 0px 0px 0px" bold>Sign up, get into the private beta <br />secure your favorite @handle</TextStyleBlock>
			</SectionBlock>
			<SectionBlock padding="30px 15% 0px 15%" paddingsm="30px 0px 30px 0px">
				...
				<Image src="/assets/uGIqYVXgxB8v1h2P4fLgyLd5k.png" maxwidth="50%" maxMobile />
			</SectionBlock>
			<SectionBlock padding="30px 10%" paddingsm="30px 10px 30px 10px" color={SectionBlockColors.Royal}>
			...
			<SectionBlock padding="30px 10% 0px 10%" paddingsm="30px 10px 0px 10px" color={SectionBlockColors.White}>
				...
				<Image src="/assets/XFGbuvFUB257uH5KETwDR6ZAryA.png" maxwidth="50%" maxMobile />
			</SectionBlock>
			<SectionBlock padding="40px 10%" paddingsm="40px 10px 40px 10px">
				...
				<Image src="/assets/AzZ2r7i8nJO2CT8KTJu9361gj0.png" maxwidth="60%" maxMobile />
			</SectionBlock>
