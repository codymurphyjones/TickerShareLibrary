  ...
  <Content>
			...
			<SectionBlock padding="60px 0% 60px 0%" paddingsm="30px 0px 30px 0px">
				...
				<TextStyleBlock align={TextStyleBlockAlign.Middle} size="22px" color="#55ccff" margin="0px 0px 0px 0px" bold>
					<EmailInput id="inputsection" sent={props.sent ? true : false} action="https://usebasin.com/f/43a0ded73401" textboxPlaceholder="Your best email" CallToAction="Request Invite">
