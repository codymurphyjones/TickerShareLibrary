...
function Home() {
  return <Content>
			<SectionBlock padding="10px 15%" paddingsm="10px 0px 10px 0px">
			...
			<SectionBlock padding="30px 15% 30px 15%" paddingsm="30px 0px 30px 0px" color={SectionBlockColors.Charcoal}>
			...
			<SectionBlock padding="30px 15%" paddingsm="30px 10px 30px 10px" color={SectionBlockColors.Royal}>
			...
			<SectionBlock padding="30px 15% 0px 15%" paddingsm="30px 10px 0px 10px" color={SectionBlockColors.White}>
			...
			<SectionBlock padding="40px 15%" paddingsm="40px 10px 40px 10px">
			...
			<Footer>
					<SectionBlock padding="30px 15% 0px 15%" paddingsm="30px 10px 0px 10px" color={SectionBlockColors.Charcoal} center>
						<Link href="http://google.com">Privacy Policy</Link><br />
						<Link href="http://google.com">Blog</Link>
					</SectionBlock>

					<SectionBlock padding="30px 15% 25px 15%" paddingsm="30px 10px 0px 10px" color={SectionBlockColors.Charcoal} center>
