...
function Home() {
  return <Content>
			...
			<SectionBlock padding="0px 15%">
				<TextStyleBlock size="32px">Real users. Verified.</TextStyleBlock>
			...
			<SectionBlock padding="30px 15%" color={SectionBlockColors.Royal}>
				...
				<TextStyleBlock size="22px" color="#f6ac3e">Tickershare is a real social network, express your opinion on tickers and the market, have an opportunity to build an audience and grow a following</TextStyleBlock>
			</SectionBlock>
			<SectionBlock padding="0px 15%" color={SectionBlockColors.White}>
				...
				<TextStyleBlock size="22px" color="#f6ac3e">Using AI and human curation, the trending page does not only show trending tickers, but also why they're trending, keeping you up to date with a quick glance.</TextStyleBlock>
				<Image src="/assets/XFGbuvFUB257uH5KETwDR6ZAryA.png" maxwidth="60%" fillArea />
			</SectionBlock>
			<SectionBlock padding="0px 15%">
				<TextStyleBlock size="32px">Intiutive. Easy to  use.</TextStyleBlock>
				<TextStyleBlock color="#f6ac3e" size="22px">.<br />
